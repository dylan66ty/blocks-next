import{o as n,d as s,f as a}from"./app.84c9ef58.js";const e=a(`<h1 id="快速开始" tabindex="-1">快速开始 <a class="header-anchor" href="#快速开始" aria-hidden="true">#</a></h1><h2 id="开发环境" tabindex="-1">开发环境 <a class="header-anchor" href="#开发环境" aria-hidden="true">#</a></h2><p>首先得有 node，并确保 node 版本是 <code>v16</code> 或以上。</p><div class="language-shell" language="shell"><pre><code><span class="token comment"># v16+</span>
