...
<template>
  <div>
    <bn-table style="width:600px;margin: 50px auto;" height="500" :columns="columns" :data="data" v-model:selection="selection"  @selection-change="onSelectionChange"></bn-table>
  </div>
</template>
