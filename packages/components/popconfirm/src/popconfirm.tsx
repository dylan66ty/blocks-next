import { createVNode, defineComponent, VNode, CSSProperties, render, nextTick, onUnmounted, ref, watch, computed, onMounted, StyleValue, RenderFunction } from 'vue'
...
export default defineComponent({
  ...
  setup(props, { slots, emit }) {
    ...
    const _slots:Record<string,VNode | RenderFunction> = {}
    if(slots.content) {
      _slots.content = slots.content
    }

    const createPopup = async () => {
      if (popupTarget) return
      vm = createVNode(Popup, popupProps, Object.keys(_slots).length ? _slots : null)
      render(vm, container)
