...
export default defineComponent({
  ...
  setup(props) {
    const styles = computed(() => {
      ...
      if (props.colSpan !== undefined && !props.block) style['--bn-grid-col-span'] = props.colSpan
      if (props.colOffset !== undefined && !props.block) style['--bn-grid-col-offset'] = props.colOffset
      return style
    })
