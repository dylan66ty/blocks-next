import { PropType, defineComponent, inject, watch, ref, reactive, TransitionGroup, computed } from 'vue'
import { tableColumnInjectionKey, TableColumnContext } from '../context'
          ...
          <ul class={[`${ns}__list`]}>
            {
              columnsList.value.map((column, index) => (
                ...
                >
                  ...
                  {
                    !column.disabled && (<div class={[`${ns}__drag-icon`]}
                      draggable
