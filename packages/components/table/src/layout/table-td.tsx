...
import { TableDataWithRaw, TableColumnData, tableColumnTypes } from '../types'
import { isFunction } from '../../../../utils/is'
import { tableInjectionKey, TableContext } from '../context'
...
export default defineComponent({
  ...
  setup(props, { slots }) {
    ...
    const renderCell = () => {
      ...
      return (
        <span
          class={['bn-table__cell']}
        >
          {isOpsType.value ? renderOps() : renderContent()}
        </span>
      );
    };
